 ...
 *
 * This module is consumed by both the API and web apps. Keep it isomorphic:
 * do not import app runtime values.
 *
 * Keep ALL_TOOL_NAMES in sync with CORE_TOOLS in apps/api/src/tools/index.ts.
 * The API registry metadata test verifies they match.
 */
...
export const MANAGEMENT_TOOLS: ToolMetadata[] = [
  ...
  },
  {
    ...
    description: "Post a comment or a reply on a task board item",
    category: "Task Board",
  },
  {
